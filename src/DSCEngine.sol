 ...
 * @author Yumeng Zhang
 *
 * This system is designed to be as minimal as possible, and have the tokens maintain a $1 peg.
 ...
 *
 * Our DSC system should always be overcollateralized. At no point should the value of all the collateral be less than the $ backed value of all the DSC.
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        // For each token, map the token to its price feed
     ...
     * @dev You must have more than 200% collateralization after this transaction
     */
    ...
    * @param user The user to liquidate. The user who has broken the health factor.
    ...
    */
        ...
        nonReentrant
    {
        ...
        // Giving liquidator 110 of WETH for 100 DSC
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // in case the liquidator is liquidated themself
    }
    ...
    */
    ...
    function getTokenAmountFromUsd(address token, uint256 usdAmountInWei) public view returns (uint256) {
        ...
        // price returned in 8 decimals, we need to convert it to 18 decimals
        // the amount is in the token's native decimals (usually 18)
        return (usdAmountInWei * PRECISION) / (uint256(price) * ADDITIONAL_FEED_PRECISION);
    }

    function getAccountCollateralValue(address user) public view returns (uint256 totalCollateralValueInUsd) {
        // loop through each collateral token, get the amount they have deposited, and then convert that to USD value

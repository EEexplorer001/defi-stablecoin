...
contract DSCEngineTest is StdCheats, Test {
    ...
    function testRevertsIfTransferFromFails() public {
        ...
        // We don't use mockDsce here because we don't need to mint any DSC
    ...
    function testEmitCollateralRedeemedWithCorrectArgs() public depositedCollateral {
        vm.expectEmit(true, true, true, true, address(dsce)); // The four true flags correspond to indexed parameters in the event
    ...
    modifier liquidated() {
        ...
        ERC20Mock(weth).mint(liquidator, collateralToCover); // collateralToCover = 20 ETH
    ...
    function testLiquidationPayoutIsCorrect() public liquidated {
        ...
        uint256 expectedWeth = dsce.getTokenAmountFromUsd(weth, amountToMint) // 100 / $18 = 5.555 ETH 5.555 * 1.1 = 6.111 ETH
            + (dsce.getTokenAmountFromUsd(weth, amountToMint) * dsce.getLiquidationBonus() / dsce.getLiquidationPrecision());
        uint256 hardCodedExpected = 6_111_111_111_111_111_110; // 20 eth is not counted because is has been deposited as collateral.
    ...
    function testUserStillHasSomeEthAfterLiquidation() public liquidated {
        ...
        uint256 usdAmountLiquidated = dsce.getUsdValue(weth, amountLiquidated); // $110
        uint256 expectedUserCollateralValueInUsd = dsce.getUsdValue(weth, amountCollateral) - (usdAmountLiquidated); //10 * 18 - 110 = $70
